...
so you learn that it *has* rained, minutes late, in coarse quanta. It clogs
...
- **PoE + Ethernet.** For sites with infrastructure, such as the observatory,
  fire stations and public buildings, power and data share one cable.
