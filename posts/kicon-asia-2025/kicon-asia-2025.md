...
The chips involved were **CLICpix v3**, **MuPix8**, and **MuPix10** — pixel detector ASICs developed in the context of high-energy physics detector R&D. These are not hobbyist components. They're small, the pads are tiny, and the bonding tolerances are unforgiving. We used a **Delvotec** wire bonder throughout.
